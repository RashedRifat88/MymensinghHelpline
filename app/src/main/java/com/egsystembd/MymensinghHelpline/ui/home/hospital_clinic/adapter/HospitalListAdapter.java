...
public class HospitalListAdapter extends RecyclerView.Adapter<HospitalListAdapter.HospitalListViewHolder> {
    ...
    List<HospitalListModel.Hospital> hospitalList = new ArrayList<>();
...
//        }
    ...
    public void setData(List<HospitalListModel.Hospital> hospitalList) {
        this.hospitalList = hospitalList;
//        this.home_module_name_ban_list = home_module_name_ban_list;
    }

    public void filterList(List<HospitalListModel.Hospital> hospitalList) {
        this.hospitalList = hospitalList;
    ...
    public HospitalListViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.single_item_hospital_list, parent, false);
        HospitalListViewHolder myViewHolder = new HospitalListViewHolder(view);
...
//                listener.onItemClick(v, myViewHolder.getPosition());
    ...
    @Override
    public void onBindViewHolder(final HospitalListAdapter.HospitalListViewHolder holder, @SuppressLint("RecyclerView") int position) {
...
//
//
        HospitalListModel.Hospital hospital = hospitalList.get(position);


        String name = hospital.getHospital();
...
//        });
        ...
        linear1.setOnClickListener(v -> {
            ...
            intent.putExtra("title", hospital.getHospital().toString());
            intent.putExtra("fromWhere", "HospitalListAdapter");
            context.startActivity(intent);
        });
    ...
    class HospitalListViewHolder extends RecyclerView.ViewHolder {
